...
foreach ($client->parseEvents() as $event) {
    switch ($event['type']) {
        case 'message':
            ...
            switch ($message['type']) {
                case 'text':
                    require_once('includes/ninestage/selectstage.php'); //選擇九階課本
                    require_once('includes/ninestage/selectlesson.php'); //選擇第幾課
                    require_once('includes/ninestage/readbook.php'); //看課文
                    require_once('includes/article/article.php'); // 看文章 還沒做
                    require_once('includes/library/library.php');
                    //require_once('includes/ninestage.php');
